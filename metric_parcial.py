        ...
        for line in lines:
            if name in line:
                if(suffix == "_001_i3d_pred.npy"):
                    print(f'processing {name} with suffix {suffix}')
...
# Define suffixes
suffixes = ["_001_i3d_pred.npy", "_005_i3d_pred.npy", "_01_i3d_pred.npy"]

# Process each group
for suffix in suffixes:
    preds, gt = load_and_concatenate_files(pred_folder, gt_folder, suffix)
